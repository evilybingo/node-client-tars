<tars>
	<application>
		...
		<server>
			...
			closeout=0
			<TarsDemo.NodeTarsServer.NodeTarsObjAdapter>
				allow
				endpoint=tcp -h 127.0.0.1 -p 14002 -t 60000
				handlegroup=TarsDemo.NodeTarsServer.NodeTarsObjAdapter
				maxconns=200000
				protocol=tars
				queuecap=10000
				queuetimeout=60000
				servant=TarsDemo.NodeTarsServer.NodeTarsObj
				shmcap=0
				shmkey=0
				threads=5
			</TarsDemo.NodeTarsServer.NodeTarsObjAdapter>
		...
		<client>
			...
			recvthread=1
			asyncthread=3
			modulename=TarsDemo.NodeTarsServer
