...
stream.prototype.compose = function ($protoMessage) {
    var str = JSON.stringify({
        iRequestId  : $protoMessage.iRequestId,
        sFuncName   : $protoMessage.sFuncName,
...
stream.prototype.feed = function (data) {
    ...
    for (var pos = 0; pos < BinBuffer.length; ) {
        ...
        protoMessage.iResultCode = result.iResultCode;
        protoMessage.sResultDesc = result.sResultDesc;
        protoMessage.iRequestId  = result.iRequestId;
        protoMessage.origin      = {
            sFuncName  : result.sFuncName,
            Arugments  : result.Arguments
        };
